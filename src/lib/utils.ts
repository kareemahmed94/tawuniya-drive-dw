...
/**
 * Calculate points from amount based on rule
 */
export function calculatePoints(
  ...
  let points = (amount / unitAmount) * pointsPerUnit;
...
/**
 * Calculate SAR from points
 */
export function calculateSAR(points: number, rate: number = 1): number {
  return points * rate;
}
